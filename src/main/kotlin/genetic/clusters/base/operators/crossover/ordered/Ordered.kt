package genetic.clusters.base.operators.crossover.ordered

import kotlin.random.Random

fun crossoverOrdered(value1: IntArray, value2: IntArray, random: Random): Pair<IntArray, IntArray> {
...
fun crossoverOrdered(value1: IntArray, value2: IntArray, point1: Int, point2: Int): Pair<IntArray, IntArray> {
    val size = minOf(value1.size, value2.size)
    var a = point1
    var b = point2
    if (a == b) b++
