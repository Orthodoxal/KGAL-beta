...
fun <T, F> SimpleClusterLifecycle<Array<T>, F>.crossoverOnePointArray(
    panmicticGABuilder: PanmicticGABuilder<Array<T>, F>,
    chance: Double = 0.9,
) = crossover(panmicticGABuilder, chance) { chromosome1, chromosome2 ->
    crossoverOnePointArray(chromosome1, chromosome2)
}
...
fun <F> SimpleClusterLifecycle<ByteArray, F>.crossoverOnePointByteArray(
    panmicticGABuilder: PanmicticGABuilder<ByteArray, F>,
    chance: Double = 0.9,
) = crossover(panmicticGABuilder, chance) { chromosome1, chromosome2 ->
    crossoverOnePointByteArray(chromosome1, chromosome2)
}

fun <F> SimpleClusterLifecycle<CharArray, F>.crossoverOnePointCharArray(
    panmicticGABuilder: PanmicticGABuilder<CharArray, F>,
    chance: Double = 0.9,
) = crossover(panmicticGABuilder, chance) { chromosome1, chromosome2 ->
    crossoverOnePointCharArray(chromosome1, chromosome2)
}

fun <F> SimpleClusterLifecycle<DoubleArray, F>.crossoverOnePointDoubleArray(
    panmicticGABuilder: PanmicticGABuilder<DoubleArray, F>,
    chance: Double = 0.9,
) = crossover(panmicticGABuilder, chance) { chromosome1, chromosome2 ->
    crossoverOnePointDoubleArray(chromosome1, chromosome2)
}

fun <F> SimpleClusterLifecycle<FloatArray, F>.crossoverOnePointFloatArray(
    panmicticGABuilder: PanmicticGABuilder<FloatArray, F>,
    chance: Double = 0.9,
) = crossover(panmicticGABuilder, chance) { chromosome1, chromosome2 ->
    crossoverOnePointFloatArray(chromosome1, chromosome2)
}
...
fun <F> SimpleClusterLifecycle<LongArray, F>.crossoverOnePointLongArray(
    panmicticGABuilder: PanmicticGABuilder<LongArray, F>,
    chance: Double = 0.9,
) = crossover(panmicticGABuilder, chance) { chromosome1, chromosome2 ->
    crossoverOnePointLongArray(chromosome1, chromosome2)
}

fun <T, F> SimpleClusterLifecycle<MutableList<T>, F>.crossoverOnePointMutableList(
    panmicticGABuilder: PanmicticGABuilder<MutableList<T>, F>,
    chance: Double = 0.9,
) = crossover(panmicticGABuilder, chance) { chromosome1, chromosome2 ->
    crossoverOnePointMutableList(chromosome1, chromosome2)
}

fun <F> SimpleClusterLifecycle<ShortArray, F>.crossoverOnePointShortArray(
    panmicticGABuilder: PanmicticGABuilder<ShortArray, F>,
    chance: Double = 0.9,
) = crossover(panmicticGABuilder, chance) { chromosome1, chromosome2 ->
    crossoverOnePointShortArray(chromosome1, chromosome2)
}
